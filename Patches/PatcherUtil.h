...
/// Helper function for getting the virtual function table for a given type.  This either requires an object instance,
...
/// @note  If not compiling using GCC or ICC, for virtual PMFs, either an object instance must be passed, or the class
///        must be default, copy, or move constructible.  Class cannot multiply inherit.
